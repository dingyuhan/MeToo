      ...
      <div class=" col-md-2 sidebar">
        <div id="accordion">
    	  ...
    	  <ol class="breadcrumb">
    	    <li><a href="#">首页</a></li>
    	    <li><a href="#">推荐管理</a></li>
    	    <li class="active">添加美食</li>
  	    </ol>
    	  <div class="table-responsive ">
    	    <h3>添加美食 <small>Food Add</small></h3>
    	    <div class="list-group ">
    	      <div class="list-group-item">
    	        <form role="form" method="post" action="/MeToo/index.php/Admin/Recommend/doAddfood">
    	          <div class="input-group"> <span class="input-group-addon">美<img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20"><img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20">食：</span>
    	          ...
    	          <div class="input-group"> <span class="input-group-addon">理由：</span>
    	            <input type="text" class="form-control" placeholder=""  name="reason">
  	            </div>
    	          <div class="input-group"> <span class="input-group-addon">美食图片：</span>
    	            <input type="text" class="form-control" placeholder=""  name="foodpic">
  	            </div>
    	          <div class="input-group"> <span class="input-group-addon">添加时间：</span>
    	            <input type="text" class="form-control" placeholder="2016-12-12"  name="foodtime">
  	            </div>
