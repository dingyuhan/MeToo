    	    ...
    	    <div class="list-group ">
    	      <div class="list-group-item">
                ...
                <input type="hidden" name="id" value="<?php echo ($record["id"]); ?>" />
    	          <div class="input-group"> <span class="input-group-addon">用<img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20"><img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20">户：</span>
    	            <input type="text" class="form-control" value="<?php echo ($record["userid"]); ?>" name="userid">
  	            </div>
    	          <div class="input-group "> <span class="input-group-addon" for="inputWarning1">兑换物品：</span>
    	            <input type="text" class="form-control" value="<?php echo ($record["goodsid"]); ?>" name="goodsid">
  	            </div>
    	          <div class="input-group"> <span class="input-group-addon">兑换时间：</span>
    	            <input type="text" class="form-control" value="<?php echo ($record["time"]); ?>" name="time">
  	            </div>
                <div class="input-group"> <span class="input-group-addon">剩余积分：</span>
                  <input type="text" class="form-control" value="<?php echo ($record["remainmark"]); ?>" name="remainmark">
                </div>
