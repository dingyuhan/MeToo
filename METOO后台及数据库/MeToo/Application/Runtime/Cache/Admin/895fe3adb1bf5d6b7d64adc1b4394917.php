      ...
      <div class=" col-md-2 sidebar">
    	...
    	<div class="col-md-10 col-md-offset-2 ">
    	  ...
    	  <div class="table-responsive ">
            ...
            <?php if(is_array($question)): $i = 0; $__LIST__ = $question;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$question): $mod = ($i % 2 );++$i;?><tr>
              	<th width="4%"><input type="checkbox" name="checkbox10" id="checkbox10"></th>
    	          <td><?php echo ($question["id"]); ?></td>
                <td><?php echo ($question["userid"]); ?></td>
    	          <td><?php echo ($question["question"]); ?></td>
                <td><?php echo ($question["time"]); ?></td>
    	        <td><a href="deletequestion/id/<?php echo ($question["id"]); ?>">删除</a></td>
        ...
        <div style="float:right">
            ...
            <?php if(is_array($answer)): $i = 0; $__LIST__ = $answer;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$answer): $mod = ($i % 2 );++$i;?><tr>
              	<th width="4%"><input type="checkbox" name="checkbox10" id="checkbox10"></th>
    	          <td><?php echo ($answer["id"]); ?></td>
                <td><?php echo ($answer["userid"]); ?></td>
                <td><?php echo ($answer["questionid"]); ?></td>
    	          <td><?php echo ($answer["answer"]); ?></td>
                <td><?php echo ($answer["answertime"]); ?></td>
    	        <td><a href="deleteanswer/id/<?php echo ($answer["id"]); ?>">删除</a> <a href="#"></a></td>
  	        </tr><?php endforeach; endif; else: echo "" ;endif; ?>     
  	      </table>
  	    </div>
        <div class="input-group pull-left form">
