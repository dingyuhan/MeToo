    	      ...
    	      <div class="list-group-item">
                ...
                <input type="hidden" name="id" value="<?php echo ($exchange["id"]); ?>" />
    	          <div class="input-group"> <span class="input-group-addon">旅<img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20"><img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20">店：</span>
    	            <input type="text" class="form-control" value="<?php echo ($food["food"]); ?>" name="food">
  	            </div>
    	          <div class="input-group "> <span class="input-group-addon" for="inputWarning1">旅店图片：</span>
    	          ...
    	          <div class="input-group"> <span class="input-group-addon">旅店位置：</span>
    	            <input type="text" class="form-control" value="<?php echo ($food["site"]); ?>" name="site">
  	            </div>
                <div class="input-group"> <span class="input-group-addon">推荐理由：</span>
                  <input type="text" class="form-control" value="<?php echo ($food["reason"]); ?>" name="reason">
                </div>
