    	  ...
    	  <div class="table-responsive ">
    	    ...
    	    <div class="list-group ">
    	      <div class="list-group-item">
    	        <form role="form" method="post" action="/MeToo/index.php/Admin/Activity/doModipk">
                <input type="hidden" name="id" value="<?php echo ($pk["id"]); ?>" />
    	          <div class="input-group"> <span class="input-group-addon">P<img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20"><img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20">K：</span>
    	            <input type="text" class="form-control" value="<?php echo ($pk["id"]); ?>" name="food">
  	            </div>
    	          
    	          <div class="input-group"> <span class="input-group-addon">pk内容：</span>
    	            <input type="text" class="form-control" value="<?php echo ($pk["theme"]); ?>" name="site">
  	            </div>
                <div class="input-group"> <span class="input-group-addon">pk时间：</span>
                  <input type="text" class="form-control" value="<?php echo ($pk["time"]); ?>" name="time">
                </div>
