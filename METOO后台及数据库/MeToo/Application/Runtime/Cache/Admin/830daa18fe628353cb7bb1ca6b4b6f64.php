      ...
      <div class=" col-md-2 sidebar">
    	...
    	<div class="col-md-10 col-md-offset-2 ">
    	  ...
    	  <div class="table-responsive ">
    	    <h3 style="display:inline;">旅店</h3>
          <form action="/MeToo/index.php/Admin/Recommend/addhotel" method="post" style="display:inline; margin-left:1100px;">
            <button type="submit" class="btn btn-warning">添加旅店</button>
          </form>
            ...
            <?php if(is_array($hotel)): $i = 0; $__LIST__ = $hotel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hotel): $mod = ($i % 2 );++$i;?><tr>
              <th width="4%"><input type="checkbox" name="checkbox10" id="checkbox10"></th>
    	        <td><?php echo ($hotel["id"]); ?></td>
              <td><?php echo ($hotel["hotel"]); ?></td>
              <td><?php echo ($hotel["hoteltime"]); ?></td>
    	        <td><?php echo ($hotel["site"]); ?></td>
    	        <td><?php echo ($hotel["praise"]); ?></td>
              <td><?php echo ($hotel["reason"]); ?></td>
    	        <td><a href="modihotel/id/<?php echo ($hotel["id"]); ?>">修改</a> <a href="deletehotel/id/<?php echo ($hotel["id"]); ?>">删除</a></td>
