    	  ...
    	  <div class="table-responsive ">
            ...
            <?php if(is_array($record)): $i = 0; $__LIST__ = $record;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$record): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><?php echo ($record["userid"]); ?></td>
    	        <td><?php echo ($record["goodsid"]); ?></td>
    	        <td><?php echo ($record["time"]); ?></td>
              <td><?php echo ($record["remainmark"]); ?></td>
    	        <td><a href="deleterecord/id/<?php echo ($record["id"]); ?>">删除</a><a href="modirecord/id/<?php echo ($record["id"]); ?>">修改</a></td>
