    	  ...
    	  <div class="table-responsive ">
    	    ...
    	    <div class="list-group ">
    	      <div class="list-group-item">
    	        <form role="form" method="post" action="/MeToo/index.php/Admin/Admin/doModi">
                <input type="hidden" name="id" value="<?php echo ($admin["id"]); ?>" />
    	          <div class="input-group"> <span class="input-group-addon">用<img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20">户<img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20">名：</span>
    	          ...
    	          <div class="input-group "> <span class="input-group-addon" for="inputWarning1">真实姓名：</span>
    	            <input type="text" class="form-control" value="<?php echo ($admin["realname"]); ?>" name="realname">
  	            </div>
    	          <div class="input-group"> <span class="input-group-addon">手机号码：</span>
    	            <input type="text" class="form-control" value="<?php echo ($admin["phonenum"]); ?>" name="phonenum">
  	            </div>
    	          ...
    	          <div class="input-group"> <span class="input-group-addon">注册时间：</span>
    	            <input type="text" class="form-control" value="<?php echo ($admin["time"]); ?>" readonly>
  	            </div>
                <div class="input-group"> <span class="input-group-addon">设置密码：</span>
    	            <input type="text" class="form-control" value="<?php echo ($admin["password"]); ?>" name="password">
  	            </div>
