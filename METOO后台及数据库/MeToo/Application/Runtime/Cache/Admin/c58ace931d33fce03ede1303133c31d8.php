      ...
      <div class=" col-md-2 sidebar">
        <div id="accordion">
    	  ...
    	  <ol class="breadcrumb">
    	    <li><a href="#">首页</a></li>
    	    <li><a href="#">推荐管理</a></li>
    	    <li class="active">景点修改</li>
  	    </ol>
    	  <div class="table-responsive ">
    	    <h3>信息修改 <small>User Modify</small></h3>
    	    <div class="list-group ">
    	      <div class="list-group-item">
    	        <form role="form" method="post" action="/MeToo/index.php/Admin/Recommend/doModiscenery">
                <input type="hidden" name="id" value="<?php echo ($scenery["id"]); ?>" />
    	          <div class="input-group"> <span class="input-group-addon">景<img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20"><img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20">点：</span>
    	            <input type="text" class="form-control" value="<?php echo ($scenery["scenery"]); ?>" name="shopping">
  	            </div>
    	          ...
    	          <div class="input-group"> <span class="input-group-addon">购物地点：</span>
    	            <input type="text" class="form-control" value="<?php echo ($scenery["site"]); ?>" name="site">
  	            </div>
                <div class="input-group"> <span class="input-group-addon">推荐理由：</span>
                  <input type="text" class="form-control" value="<?php echo ($scenery["reason"]); ?>" name="reason">
                </div>
