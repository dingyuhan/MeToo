      ...
      <div class=" col-md-2 sidebar">
        <div id="accordion">
    	  ...
    	  <ol class="breadcrumb">
    	    <li><a href="#">首页</a></li>
    	    <li><a href="#">活动管理</a></li>
    	    <li class="active">添加猜猜看</li>
  	    </ol>
    	  <div class="table-responsive ">
    	    <h3>添加猜猜看 <small>Guess Add</small></h3>
    	    <div class="list-group ">
    	      <div class="list-group-item">
    	        <form role="form" method="post" action="/MeToo/index.php/Admin/Activity/doAddguess">
    	          <div class="input-group"> <span class="input-group-addon">问<img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20"><img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20">题：</span>
    	            <input type="text" class="form-control" placeholder=""  name="question">
  	            </div>
    	          <div class="input-group"> <span class="input-group-addon">图片：</span>
                  <input name="picture" id="" type="file" style="margin-left:20px;">
                </div>
    	          <div class="input-group"> <span class="input-group-addon">时间：</span>
    	            <input type="text" class="form-control" placeholder="2016-12-12"  name="time">
  	            </div>
  	            </div>
