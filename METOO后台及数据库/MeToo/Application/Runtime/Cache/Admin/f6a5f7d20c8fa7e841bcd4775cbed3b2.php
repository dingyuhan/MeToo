      ...
      <div class=" col-md-2 sidebar">
        <div id="accordion">
    	  ...
    	  <ol class="breadcrumb">
    	    <li><a href="#">首页</a></li>
    	    <li><a href="#">推荐管理</a></li>
    	    <li class="active">购物修改</li>
  	    </ol>
    	  <div class="table-responsive ">
    	    <h3>信息修改 <small>User Modify</small></h3>
    	    <div class="list-group ">
    	      <div class="list-group-item">
    	        <form role="form" method="post" action="/MeToo/index.php/Admin/Recommend/doModishopping">
                <input type="hidden" name="id" value="<?php echo ($shopping["id"]); ?>" />
    	          <div class="input-group"> <span class="input-group-addon">购<img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20"><img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20">物：</span>
    	            <input type="text" class="form-control" value="<?php echo ($shopping["shopping"]); ?>" name="shopping">
  	            </div>
    	          <div class="input-group "> <span class="input-group-addon" for="inputWarning1">购物图片：</span>
                  <input name="thumb" id="" type="file" style="margin-left:20px;">
    	            <!-- <input type="text" class="form-control" value="<?php echo ($exchange["gnum"]); ?>" name="gnum"> -->
  	            </div>
    	          <div class="input-group"> <span class="input-group-addon">购物地点：</span>
    	            <input type="text" class="form-control" value="<?php echo ($shopping["site"]); ?>" name="site">
  	            </div>
                <div class="input-group"> <span class="input-group-addon">推荐理由：</span>
                  <input type="text" class="form-control" value="<?php echo ($shopping["reason"]); ?>" name="reason">
                </div>
