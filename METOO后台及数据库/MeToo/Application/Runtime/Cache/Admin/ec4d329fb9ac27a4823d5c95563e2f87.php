      ...
      <div class=" col-md-2 sidebar">
        <div id="accordion">
    	  ...
    	  <div class="table-responsive ">
    	    <h3 style="display:inline;">美食</h3>
          <form action="/MeToo/index.php/Admin/Recommend/addfood" method="post" style="display:inline; margin-left:1100px;">
            <button type="submit" class="btn btn-warning">添加美食</button>
          </form>
            ...
            <?php if(is_array($food)): $i = 0; $__LIST__ = $food;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$food): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($food["foodpic"]); ?></td>
                <td><?php echo ($food["foodtime"]); ?></td>
    	          <td><?php echo ($food["site"]); ?></td>
    	          <td><?php echo ($food["praise"]); ?></td>
                <td><?php echo ($food["reason"]); ?></td>
    	          <td><a href="modifood/id/<?php echo ($food["id"]); ?>">修改</a> <a href="deletefood/id/<?php echo ($food["id"]); ?>">删除</a></td>
