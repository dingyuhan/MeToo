      ...
      <div class=" col-md-2 sidebar">
        <div id="accordion">
    	  ...
    	  <div class="table-responsive ">
    	    <h3>添加景点 <small>Scenery Add</small></h3>
    	    <div class="list-group ">
    	      <div class="list-group-item">
    	        <form role="form" method="post" action="/MeToo/index.php/Admin/Recommend/doAddscenery">
    	          <div class="input-group"> <span class="input-group-addon">景<img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20"><img src="/MeToo/Public/end/images/em.png" alt="" width="6" height="20">点：</span>
    	            <input type="text" class="form-control" placeholder=""  name="scenery">
  	            </div>
                ...
                <div class="input-group"> <span class="input-group-addon">景点图片：</span>
    	          ...
    	          <div class="input-group"> <span class="input-group-addon">添加时间：</span>
    	            <input type="text" class="form-control" placeholder="2016-12-12"  name="scenerytime">
  	            </div>
