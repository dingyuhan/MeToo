        ...
        <div id="accordion">
    	  ...
    	  <div class="table-responsive ">
            ...
            <th width="4%"><input type="checkbox" name="checkbox10" id="checkbox10"></th>
    	        ...
    	        <th width="13%">用户id</th>
              <th width="25%">拍摄地点</th>
    	        <th width="10%">足迹缩略图</th>
    	        <th width="7%">操作</th>
  	        </tr>
    	      <?php if(is_array($footprint)): $i = 0; $__LIST__ = $footprint;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$footprint): $mod = ($i % 2 );++$i;?><tr>
              <th width="4%"><input type="checkbox" name="checkbox10" id="checkbox10"></th>
    	        <td><?php echo ($footprint["id"]); ?></td>
    	        <td><?php echo ($footprint["userid"]); ?></td>   	        
              <td><?php echo ($footprint["site"]); ?></td>
    	        <td><img src="images/head.gif" style="width:50px;height:30px"></td>
    	        <td><a href="deletefoot/id/<?php echo ($footprint["id"]); ?>">删除</a></td>
